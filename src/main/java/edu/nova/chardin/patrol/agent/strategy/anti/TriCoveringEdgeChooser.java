...
public class TriCoveringEdgeChooser implements CoveringEdgeChooser {
  @NonNull
  ...
  @NonNull
  private final CoveringEdgeChooser c;
  ...
  public Optional<EdgeId> choose(
    ...
    if (ar.isPresent()) {
      ...
      final Optional<EdgeId> br = b.choose(context, coveredVertices, verticesData, edgesData, edgesToAvoid);
      
      if (br.isPresent()) {
        r = br;
      } else {
        r = c.choose(context, coveredVertices, verticesData, edgesData, edgesToAvoid);
      }
    }
